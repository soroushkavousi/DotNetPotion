...
{
    /// <summary>
    /// Provides extension methods for registering the <see cref="SemaphorePool"/> service with the dependency injection container.
    /// </summary>
    public static class ServiceInstaller
    {
        ...
        /// <summary>
        /// Adds the <see cref="SemaphorePool"/> service to the specified <see cref="IServiceCollection"/> with configuration options.
        /// </summary>
        /// <param name="services">The service collection to add the <see cref="SemaphorePool"/> service to.</param>
